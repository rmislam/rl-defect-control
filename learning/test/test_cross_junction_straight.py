...
if __name__ == "__main__":
    ...
    model = PPO.load(dir_path + '/../saved_models/ppo-active-nematic-multibinary-CROSS_JUNCTION-straight-single-defect/ppo-active-nematic-multibinary-CROSS_JUNCTION_280064_steps.zip', env=env)
