...
if __name__ == "__main__":
    ...
    model = PPO.load(dir_path + '/../saved_models/ppo-active-nematic-multibinary-T_JUNCTION-down/ppo-active-nematic-multibinary-T_JUNCTION_300032_steps.zip', env=env)
