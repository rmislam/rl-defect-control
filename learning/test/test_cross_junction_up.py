...
if __name__ == "__main__":
    ...
    model = PPO.load(dir_path + '/../saved_models/ppo-active-nematic-multibinary-CROSS_JUNCTION-up/ppo-active-nematic-multibinary-CROSS_JUNCTION_192000_steps.zip', env=env)
